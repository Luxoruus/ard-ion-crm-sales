  ...
  setup() {
    ...
    const translations = {
      en: {
        ...
        selectOpportunity: 'Select a Record',
        searchOpportunities: 'Search Records',
        searchPlaceholder: 'Search by name or customer/party...',
        ...
        noAvailableOpportunities: 'No available records',
        refresh: 'Refresh',
      ...
      ar: {
        ...
        selectOpportunity: 'اختر سجلاً',
        searchOpportunities: 'ابحث في السجلات',
        searchPlaceholder: 'ابحث بالاسم أو العميل/الطرف...',
        customer: 'العميل/الطرف',
        back: 'رجوع',
        progress: 'التقدم',
        ...
        noAvailableOpportunities: 'لا توجد سجلات متاحة',
        refresh: 'تحديث',
