<template>
  <div id="app" :class="{ 'rtl': currentLanguage === 'ar' }">
    <!-- Loading Overlay -->
    ...
    <!-- Login Page -->
    <div v-if="!isAuthenticated" class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
    ...
    <div v-else class="min-h-screen bg-gray-50">
      ...
      <div v-if="activeTab === 'fill-survey'" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid gap-4">
              ...
              >
                <div class="flex justify-between items-start">
                  <div class="flex-1">
                    <h3 class="font-semibold text-gray-900 text-lg mb-2">{{ opportunity.opportunity_name }}</h3>
          ...
          <div v-else class="space-y-6">
              ...
              <div>
                ...
                <p class="text-gray-600 mt-1 flex items-center">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6M8 8v10l4-2 4 2V8"></path>
                  </svg>
            ...
            <div class="space-y-8">
              <div
                v-for="(question, index) in currentSurveyTemplate?.questions"
                :key="question.name"
              ...
              >
                <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-start">
                  <span class="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-bold mr-3 mt-0.5">
                    {{ index + 1 }}
                  </span>
                  <span>
                    {{ question.question }}
                ...
                <div v-else-if="question.question_type === 'Yes/No'" class="ml-11">
                  <div class="flex space-x-4">
                    <button
                      @click="surveyAnswers[question.name] = 'Yes'"
                      :class="[
                    ...
                    <button
                      @click="surveyAnswers[question.name] = 'No'"
                      :class="[
                        'px-8 py-3 rounded-lg border-2 transition-all duration-200 font-medium flex items-center',
      ...
      <div v-if="activeTab === 'my-surveys'" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div class="space-y-4">
            <div
              v-for="response in filteredSurveyResponses"
              :key="response.name"
            ...
            >
              <div class="flex justify-between items-start">
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <button
                    @click="viewSurveyResponse(response)"
...
export default {
  ...
  setup() {
    ...
    const fetchOpportunities = async () => {
      ...
      opportunities.value = [
        {
          name: 'OPP-DEDICATED-001',
          opportunity_name: 'Enterprise Cloud Migration Project',
        ...
        {
          name: 'OPP-HOTELS-001',
          opportunity_name: 'Hotel Management System Implementation',
          doctype: 'Opportunity Hotels',
          customer_name: 'Grand Hotel Chain',
          status: 'Quotation'
        },
        {
          name: 'OPP-SM-001',
          opportunity_name: 'Small Business CRM Solution',
          doctype: 'Opportunity SM',
          customer_name: 'Local Business Inc',
          status: 'Open'
        },
        {
          name: 'OPP-TENDERS-001',
          opportunity_name: 'Government Digital Transformation',
          doctype: 'Opportunity Tenders',
          customer_name: 'Ministry of Technology',
          status: 'Open'
        }
      ]
    }
    ...
    const submitSurvey = async () => {
      ...
      try {
        ...
        surveyResponses.value.unshift({
          ...
          opportunity_name: selectedOpportunity.value.opportunity_name,
